...
import ExcavacaoFilter from '../../components/ExcavacaoFilter';
...
export const metadata = {
  ...
  description:
    'Equipamentos para escavação convencional e NATM: jumbos de perfuração, roadheaders, suporte, revestimento, transporte de material e auxiliares.',
};

export default function Escavacao() {
  const p = PRODUCTS.find((x) => x.slug === 'escavacao-suporte');
  const others = PRODUCTS.filter((x) => x.slug !== 'escavacao-suporte');
      ...
      <section className="dark2" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <Reveal>
            ...
            <h2 className="h2" style={{ color: '#fff' }}>Equipamentos de escavação e suporte.</h2>
            <p style={{ color: '#c9c6be', maxWidth: '60ch' }}>
              Do desmonte ao revestimento definitivo. Filtre pelo grupo de equipamento.
            </p>
          </Reveal>
