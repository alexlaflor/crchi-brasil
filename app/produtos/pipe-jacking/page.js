...
import PipeJackingFilter from '../../components/PipeJackingFilter';
...
export const metadata = {
  title: 'Pipe jacking',
  description:
    'Máquinas de pipe jacking e microtúnel da CRCHI: balanço por lama, seção retangular, cravação direta, mineração e cortina de tubos.',
};

export default function PipeJacking() {
  const p = PRODUCTS.find((x) => x.slug === 'pipe-jacking');
  const others = PRODUCTS.filter((x) => x.slug !== 'pipe-jacking');
      ...
      <section className="dark2" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <Reveal>
            ...
            <h2 className="h2" style={{ color: '#fff' }}>Equipamentos de pipe jacking.</h2>
            <p style={{ color: '#c9c6be', maxWidth: '60ch' }}>
              Configurações para cada tipo de frente e travessia. Filtre pelo tipo.
            </p>
          </Reveal>
