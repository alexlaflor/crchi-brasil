...
export const PRODUCTS = [
  ...
  },
  {
    ...
    idx: '03',
    title: 'Escavação convencional de túneis (NATM)',
    short:
...

  {
    ...
    short:
      'Equipamentos agrícolas para preparo de solo, plantio e colheita — linha em desenvolvimento.',
    intro:
      'Linha de máquinas agrícolas da CRCHI Brasil para o campo brasileiro. Conteúdo genérico e provisório — atualize com os equipamentos, especificações e imagens oficiais quando disponíveis.',
    hero: '/images/products/agro-hero.jpg',
    image: '/images/products/agro-1.jpg',
    glyph: 'tbm',
    specs: [
      ['Segmentos', 'Preparo de solo · Plantio · Colheita'],
      ['Aplicações', 'Grãos · Cana · Culturas diversas'],
      ['Situação', 'Linha em desenvolvimento'],
      ['Suporte', 'Peças e assistência local no Brasil'],
    ],
    features: [
      ['Preparo de solo', 'Equipamentos para preparo e conservação do solo, com foco em produtividade.'],
      ['Plantio', 'Soluções de plantio adaptadas às culturas e às condições do campo brasileiro.'],
      ['Colheita', 'Máquinas de colheita para maior eficiência e menor perda.'],
    ],
  },
